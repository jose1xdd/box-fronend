						...
						<div className="p-4 max-w-5xl mx-auto flex">
							<div className="w-2/3">
								<table className="w-full">
									<thead>
										<tr>
											<th className="border-[#1e1e1e] border-[4px] p-3 bg-[#cd1919] text-white text-center text-[150%] tracking-widest" id='titulos-grandes'>Criterio</th>
										</tr>
									</thead>
									<tbody>
										{criteriosData.map((criterio, index) => (
											<tr key={index}>
												<td className=" border-[#1e1e1e] border-[4px] p-3 bg-[#dfdfdf] text-center text-black">{criterio.name}</td>
											</tr>
										))}
									</tbody>
								</table>
