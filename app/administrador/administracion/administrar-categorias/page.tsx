				...
				<form className='flex col' onSubmit={handleSubmit}>
					<div className='w-2/4'>
						...
						<input
							...
							className={(categoria === '' ? 'border-[3px] border-red-700 ' : '') + 'border-[3px] border-black bg-white rounded-full w-full h-10 pl-5 text-black'}
							id="texto-general"
					...
					<div className='w-1/4 mx-4'>
						...
						<div className='flex items-center'>
							...
							<input
								...
								className="bg-neutral-200 rounded-full w-full h-10 text-black text-center border-[3px] border-black bg-white"
								id="texto-general"
							/>
							<button
								type='button'
