					...
					<div className="max-w-xl mx-auto my-5">
						<div className="flex">
							<div className="w-1/3 m-0">
								<div className='bg-[#4B4B4B] text-white rounded-full w-full h-10 mx-5 my-2 flex items-center justify-center' id='texto-general'>
                                        Nombre:
								</div>
							</div>
							<div className="w-2/3 mx-2" id='texto-general'>
								<input
									...
									className={(nombreVacio() ? 'border-[3px] border-red-700 ' : 'border-black') + 'bg-white rounded-full w-full h-10 mx-5 my-2 pl-4 text-black border-[3px] border-black'}
						...
						<div className="flex">
							...
							<div className="w-2/3 mx-2" id='texto-general'>
								<input
									...
									onChange={handleInputChange}
									className={(descripcionVacia() ? 'border-[3px] border-red-700 ' : 'border-black') + 'bg-white rounded-lg w-full h-40 mx-5 my-2 pl-4 text-black border-[3px] border-black'}
