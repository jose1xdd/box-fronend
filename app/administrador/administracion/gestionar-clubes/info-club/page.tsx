...
import pingo from '@/app/administrador/css/profiles.module.css';
						...
						<div className="max-w-xl mx-auto my-5">
							<div className="flex">
								...
								<div className="w-2/3 mx-2" id='texto-general'>
									<div className='bg-white rounded-full w-full h-10 mx-5 my-2 flex items-center justify-center text-black border-[3px] border-black' id='texto-general'>
										{datosClub.name}
									</div>
								</div>
							</div>
							<div className="flex">
								<div className="w-1/3 mx-2">
									<div className='text-white bg-[#4B4B4B] rounded-full w-full h-10 mx-5 my-2 flex items-center justify-center' id='texto-general'>
                                    Descripción:
									</div>
								</div>
								<div className="w-2/3 mx-2" id='texto-general'>
									<textarea className='bg-white border-[3px] border-black rounded-lg w-full h-40 mx-5 my-2 flex items-center justify-center text-black p-2' id='texto-general' disabled rows={6}>
