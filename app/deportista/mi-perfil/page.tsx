...
export default function Home() {
	...
	async function cambiar(
		datos: { token: any; userId: any },
		info: { nombre: any; apellido: any; direccion: any; telefono: any }
	): Promise<void> {
		try {
			const headers = {
				sessiontoken: datos.token,
		...
		<>
            ...
            MI PERFIL
					...
					<div className="p-4 max-w-5xl mx-auto flex">
                      ...
                      Nombre:
									...
									<div className="w-2/3 mx-2">
										{esEditable ? (
											<input
												type="text"
												className="bg-white border-[3px] border-black rounded-full w-full h-10 mx-5 my-2 text-center text-black"
												id="texto-general"
											...
											<div
												className="bg-neutral-200 border-[3px] border-black rounded-full w-full h-10 mx-5 my-2 flex items-center justify-center text-black"
												id="texto-general"
											>
												{datosPerfil.nombre}
											</div>
								...
								<div className="flex">
									...
									{nombreVacio() && (
										<label className="text-red-600 mx-10">
                      ...
                      El campo no puede estar vacío
									...
									{!numeroValido() && !numeroVacio() && (
										<label className="text-red-600 mx-10">
                      El campo sólo puede contener números
										</label>
									)}
                      ...
                      Correo:
						...
						<div className="w-1/3 flex flex-col justify-center items-center">
							{datosPerfil.imagen != '' && (
								<img src={datosPerfil.imagen} className="w-64 h-64" />
							)}
							<button
								className={`${styles.button} w-60 h-10  py-2 px-4 mt-7`}
                ...
                Cargar nueva foto de perfil
						...
						{modalVisible && (
							<ModalImage setView={setModalVisible}></ModalImage>
						)}
					</div>
				</div>
			)}
