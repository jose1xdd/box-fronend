					...
					<form>
						<div className="p-4 max-w-5xl mx-auto flex">
							<div className="w-2/3 pr-4">
								<div className="flex">
									<div className="w-1/3 mx-2">
										<div className={styles.label + ' rounded-full w-full h-10 mx-5 my-2 flex items-center justify-center text-black'} id='texto-general'>
										Buscar usuario:
										</div>
									</div>
								...
								<div className="flex">
									...
									<div className="w-2/3 mx-2">
										<input
											type="text"
											className={(asuntoVacio() ? 'border-[3px] border-red-700 ' : '') + 'bg-white text-black border-[3px] border-black rounded-full w-full h-10 mx-5 my-2 pl-4 text-black'} id='texto-general'
								...
								<div className="flex">
									...
									<div className="w-2/3 mx-2">
										<textarea
											className={(cuerpoVacio() ? 'border-[3px] border-red-700 ' : '') + 'bg-white text-black border-[3px] border-black rounded-lg w-full h-40 mx-5 my-2 p-2 text-black'} id='texto-general'
							...
							<div className="w-1/3 flex flex-col items-center ml-4 my-2">
								<div className="flex">
									<button type='button' onClick={()=> handlerSetParticipantes(true)} className={(seleccionInvalida() ? kevin.buttonDisabled + ' cursor-not-allowed' : kevin.button) + ' text-white rounded p-2 mr-2'}>
					                Eliminar usuario
									</button>
									<button type='button' onClick={() => handlerSetParticipantes(false)} className={(seleccionInvalida() ? kevin.buttonDisabled + ' cursor-not-allowed' : kevin.button) + ' text-white rounded p-2 ml-2'}>
					                Agregar Usuario
									</button>
								</div>
								<div className={styles.label + ' rounded-full w-full h-10 mx-5 my-2 flex items-center justify-center text-black mt-4 mb-4'} id='texto-general'>
								Destinatarios
								</div>
								<div className="flex w-full">
									<textarea
										...
										value={correos}
										readOnly
										className={(correosVacios() ? 'border-[3px] border-red-700 ' : '') + 'bg-white text-black border-[3px] border-black rounded-lg w-full h-40 p-2 text-black'} id='texto-general'
								...
								<div className="mt-2 flex justify-end">
									<button
										type="button"
										className={((correosVacios() || asuntoVacio() || cuerpoVacio()) ? kevin.buttonDisabled + ' cursor-not-allowed' : kevin.button) + ' w-60 h-10 text-white py-2 px-4 rounded-lg'}
