...
export function InputImageArea({ setFile }: { setFile: React.Dispatch<React.SetStateAction<fileImageFormat>> }) {
	...
	return (
		<div className='flex border h-full w-full flex-col justify-center align-middle items-center space-y-4 border-dashed rounded-md' onDrop={handleDrop} onDragOver={(event) => event.preventDefault()}>
