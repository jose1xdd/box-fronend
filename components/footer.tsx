import Logo_UFPS from '@/public/images/logo_ufps.png';
import Image from 'next/image';
import styles from './footer.module.css';

export default function Footer(){
	return(
		<footer className={`bg-[#141414] p-4 mt-8 ${styles.footer}`}>
			<div className='md:grid md:grid-cols-5 space-y-10 md:space-y-0 items-center justify-center text-center'>
				<div className='flex justify-center items-center'>
					<Image src={Logo_UFPS} alt='Logo UFPS' className='w-40'></Image>
				</div>
